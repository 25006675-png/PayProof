  ...
  return (
    <div className="buyer-shell">
      ...
      <main className="buyer-main">
        ...
        <section className="app-title"><div><span>BUYER WORKSPACE · SUI TESTNET</span><h1>Your money waits for proof.</h1><p>Two deliveries need attention. Every protected dollar remains visible below.</p></div><NewOrder onCreated={handleCreated} /></section>
